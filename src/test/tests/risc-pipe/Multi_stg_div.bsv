...
module mkMulti_stg_div ( Multi_stg_div _unused_ ) provisos(  );
    ...
    UInt#(32) _Start_carg_1303 = ?;
    UInt#(32) _Start_carg_1304 = ?;
    UInt#(32) _Start_carg_1305 = ?;
    UInt#(32) _Start_carg_1306 = ?;
    UInt#(5) _Start_carg_1307 = ?;
    Bool _Start_carg_1308 = ?;
    ...
    begin
        _Start_carg_1303 = _Start_nnum;
        _Start_carg_1304 = _Start_denom;
        _Start_carg_1305 = _Start_nq;
        _Start_carg_1306 = _Start_na;
        _Start_carg_1307 = ( _Start_cnt + 5'd1 );
        _Start_carg_1308 = _Start_retQuot;
    end
    rule s_Start_execute (( ( ! ( _Start___condStage__3 == 1'd0 ) ) || outputQueue.canWrite(_Start__threadID) ));
        ...
        if ( ( _Start___condStage__3 == 1'd1 ))
        begin
            fifo__input__TO_Start.enq(E__input__TO_Start { num : _Start_carg_1303,retQuot : _Start_carg_1308,_threadID : _Start__threadID,quot : _Start_carg_1305,cnt : _Start_carg_1307,denom : _Start_carg_1304,acc : _Start_carg_1306 });
        end
